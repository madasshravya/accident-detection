...
from mail import send_email  # Importing the send_email function from mail.py
...
class AccidentDetectionApp:
    def __init__(self):
        ...
        #Flag to trach whether email has been sent
    ...
    def run(self):
        ...
        if not self.email_sent:
            ...
            # After running the detection, call the send_email function from mail.py
...
# Instantiate the AccidentDetectionApp class and run the application
